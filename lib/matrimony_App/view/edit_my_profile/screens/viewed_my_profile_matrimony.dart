...
class ViewedMyProfileMatrimony extends StatelessWidget {
  const ViewedMyProfileMatrimony({super.key});
    ...
    return Column(
      ...
      children: [
        Stack(
          ...
          children: [
            CircleAvatar(radius: 34, backgroundColor: ColorConstants.pinkColor),
            CircleAvatar(
                radius: 31, backgroundColor: ColorConstants.whiteColor),
            CircleAvatar(
              radius: 28,
